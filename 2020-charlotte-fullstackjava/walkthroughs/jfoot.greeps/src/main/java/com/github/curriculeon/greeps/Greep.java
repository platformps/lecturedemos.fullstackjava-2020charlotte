...
public class Greep extends Creature {
    ...
    public void seekTomatoPile() {
        TomatoPile surroundingTomatoPile = getSurroundingTomatoPile();
        boolean isPilePresent = surroundingTomatoPile != null;
        if (isPilePresent) {
            turnTowards(surroundingTomatoPile);
            checkFood();
        }
        move();
    }
    ...
    public Boolean isWaitingForAssistance() {
        return this.isAtTomatoes() && !this.isCarryingTomato();
    }
